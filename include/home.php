					...
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="f-grid py-2">
							...
							<div class="box-scroll">
								<div class="scroll">
									<?php
										$sql_product_slidebar = mysqli_query($con,"SELECT * FROM tbl_sanpham WHERE sanpham_hot='0' ORDER BY sanpham_id DESC ");
										while($row_sanpham_slidebar = mysqli_fetch_array($sql_product_slidebar)){
									...
									<div class="row">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<del><?php echo $row_sanpham_slidebar['sanpham_gia']?> <sup>vnđ</sup></del>
											<a href="" class="price-mar mt-2"><?php echo $row_sanpham_slidebar['sanpham_giakhuyenmai'] ?> <sup>vnđ</sup></a>
										</div>
									</div>
									<?php
										}
